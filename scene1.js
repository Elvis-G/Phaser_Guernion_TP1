...
repeat:-1
	...
	this.physics.add.collider(this.player, this.ennemi1, hitEnnemi1, null, this);
	this.physics.add.collider(this.player, this.ennemi2, hitEnnemi2, null, this);
	this.physics.add.collider(this.player, this.ennemi3, hitEnnemi3, null, this);

	this.projectiles = this.physics.add.group();
	this.physics.add.collider(this.projectiles, this.platforms, projectileplateforms, null, this);
	this.physics.add.collider(this.player, this.projectiles, hitprojectile, null, this);

	this.physics.add.collider(this.bananes, this.platforms);
	this.physics.add.overlap(this.bananes, this.player, collectCollectible, null, this);
...
if (this.compteur == 1){
	this.scene.start("deuxieme_scene", {test:this.compteur, test2:this.compteur});
}
